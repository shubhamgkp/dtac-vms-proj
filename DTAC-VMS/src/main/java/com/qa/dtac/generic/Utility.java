...
public class Utility {
	...
	public static void dataBaseConnection(String sqlQuery) {
		...
		// String
		// url="jdbc:informix-sqli://192.24.207.114:13001/emcom:INFORMIXSERVER=ids_emcom;IFX_LOCK_MODE_WAIT=2;IFX_ISOLATION_LEVEL=1";
		String un = "postgres";
		String pwd = "postgres";
		try {
	...
	public static String getAlphaNumericString(int n) {
		...
		String AlphaNumericString = "AB" + "___" + "ab";
	...
	public static boolean verifyElementIsPresent(WebDriver driver, WebElement element, int timeOut)// used for loaster
																									// error
	{
	...
	public static void scrollDown(WebDriver driver, List<WebElement> ele) 
	{
		JavascriptExecutor js = (JavascriptExecutor) driver;
       	//js.executeScript("window.scrollBy(0,1000)", ele);
...
//		try {
//			JavascriptExecutor js = (JavascriptExecutor) driver;
//			js.executeScript("(JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView()", ele);
//		} catch (Exception e) {
//			JavascriptExecutor js = (JavascriptExecutor) driver;
//			js.executeScript("window.scrollBy(0,1000)", ele);
